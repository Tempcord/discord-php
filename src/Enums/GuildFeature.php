...
enum GuildFeature: string
{
    ...
    case MEMBER_VERIFICATION_MANUAL_APPROVAL = 'MEMBER_VERIFICATION_MANUAL_APPROVAL';
    case MORE_SOUNDBOARD = 'MORE_SOUNDBOARD';
    ...
    case GUESTS_ENABLED = 'GUESTS_ENABLED';
    case GUILD_TAGS = 'GUILD_TAGS';
    case ENHANCED_ROLE_COLORS = 'ENHANCED_ROLE_COLORS';
}
