...
While Discord PHP should cover most Events out of the box, you can also opt to listen to raw events, as they are emitted from Discord with minimal processing.

These raw events are also used internally, unless you have vast knowledge of Discords Gateway and Discord PHP's internal workings, you should probably refrain from modifying the payload itself.
