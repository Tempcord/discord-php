...
For this, you can use `CyberWolf\Discord\Gateway\Shard`.
...
Note that this method takes an instance of `CyberWolf\Discord\Gateway\ShardInterface`. If you need additional logic in order to prepare the shard array for the identify payload, you can create your own implementation for it.
